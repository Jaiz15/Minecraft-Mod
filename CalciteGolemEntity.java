...
public class CalciteGolemEntity extends TameableEntity {
    ...
    private static final Set<Item> TAMING_INGREDIENTS = Sets.newHashSet(Items.AMETHYST_SHARD, Items.QUARTZ);
    ...
    protected void initCustomGoals() {
        this.goalSelector.add(2, new FollowOwnerGoal(this, 1.0, 5.0f, 1.0f, false));
        this.goalSelector.add(6, new FollowMobGoal(this, 1.0, 10.0f, 2.0f));
